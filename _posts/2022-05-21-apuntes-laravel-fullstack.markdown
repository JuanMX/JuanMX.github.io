...
<div class="hover-hand">
    Para hacer que en un blade de Laravel el mouse cambie por una mano al hacer un *hover* sobre un elemento encerrado en un <code>&lt;div&gt;&lt;/div&gt;</code> se puede hacer lo siguiente. 
</div>
