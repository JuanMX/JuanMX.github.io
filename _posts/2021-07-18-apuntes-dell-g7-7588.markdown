...
Después investigar encontré las laptops Dell de serie G que incluyen una tarjeta gráfica Nvidia. La mayor ventaja era el precio, por debajo de la competencia. Una desventaja para mí es que su sistema de enfriamiento. Como la quería para *deep learning* y no para largas sesiones de videojuegos me pareció una buena compra.

En esta entrada de blog se encuentran mis apuntes de la laptop.
